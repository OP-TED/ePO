...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!--    dct:title -->
    <xsl:variable name="ontologyTitle" select="'eProcurement Ontology - eContract'"/>
    <!--    dct:description-->
    <xsl:variable name="ontologyDescription"
        select="
            'This module provides the definitions for the eContract of eProcurement ontology.
    ...
    <xsl:variable name="abstractCore"
        select="'This artefact provides the ontology eContract specification.'"/>
    ...
    <xsl:variable name="preferredNamespacePrefix" select="'epo-con'"/>
